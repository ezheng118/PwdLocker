...
class LockerUI:
    ...
    def __parse_error(self, return_val):
        if return_val != ReturnCode.success:
                self.scrn.clear()

                self.scrn.addstr(0, 0, f"Password operation failed {return_val}", curses.color_pair(2))
    ...
    def __rm_acct(self):
        ...
        while(k != ord('q')):
            ...
            if k == curses.KEY_DOWN:
                ...
                ret_val = self.manager.rm_acct(acct_name)
